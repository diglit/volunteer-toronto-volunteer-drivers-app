...
const ApplicationReview = ({ id }: Props): React.ReactElement => {
    ...
    return (
        <>
            ...
            <div>
                <Button variant="outlined" color="primary" onClick={() => setOpenReject(true)}>reject</Button>
                ...
                <Button variant="outlined" color="primary" onClick={() => setOpenApprove(true)}>approve </Button>
